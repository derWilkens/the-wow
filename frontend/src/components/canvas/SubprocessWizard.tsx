...
export function SubprocessWizard({
  ...
  return (
    <div className="absolute inset-0 z-40 flex items-center justify-center bg-slate-950/55 p-4 backdrop-blur-sm">
      <div data-testid="subprocess-wizard" className="w-full max-w-2xl rounded-[30px] border border-white/10 bg-slate-950/96 p-6 shadow-[0_40px_120px_rgba(2,8,12,0.72)]">
